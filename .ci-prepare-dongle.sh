...
export LINUX_PACKAGE=\$(cat debian/linux-image/DEBIAN/control | grep "Package: " | sed "s/Package: //")
export LINUX_VERSION=\$(cat debian/linux-image/DEBIAN/control | grep "Version: " | sed "s/Version: //")
